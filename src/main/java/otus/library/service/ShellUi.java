...
public class ShellUi {
    ...
    public void insertBook(Long id, String name, Long author, Long genre){
        bookRepository.save(new Book(id, name, authorRepository.getOne(author), genreRepository.getOne(genre)));
    }
    ...
    public void insertComment(Long id, Long book, String user, String comment){
        commentRepository.save(new Comment(id, bookRepository.getOne(book), userRepository.getOne(user), comment));
    }
